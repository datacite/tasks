        ...
        Scenario: Claim DOI
            Given that the user is logged-in
             ...
             Then the "Claim DOI" button should dissapear
              And the label "Claiming DOI" should be shown
              And the DOI Claim should be sent to the ORCID profile
              And after a few minutes the label "Claimed DOI" should replace the previous label
        ...
        Scenario: Remove DOI Claim
            Given that the user is logged-in
             ...
             Then the "Remove Claim" button should dissapear
              And the label "Removing Claim" should be shown
